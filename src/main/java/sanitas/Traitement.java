...
import static sanitas.Creation.ecrireFichierSortie;
import static sanitas.Creation.ecrireHistoriqueSurDisque;
...
public class Traitement {
    ...
    public static void appliquerPolice(Client client, Reclamation rec, List<Police> lesPolices,HistRemb historique, String fichierHistoriq,  String output) throws OperationInvalideException, IOException{
        ...
        ecrireHistoriqueSurDisque(historique, fichierHistoriq);
        ecrireFichierSortie(rec,listeRemboursement, output);
    }
