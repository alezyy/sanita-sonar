...
import static sanitas.Client.*;
import static sanitas.Message.*;
import static sanitas.FileReader.*;
import static sanitas.Reclamation.validerReclamation;
import static sanitas.Traitement.appliquerPolice;
import static sanitas.Traitement.creerMonnaie;
...
import principal.OperationInvalideException;
...
public class Creation {
    ...
    public static void traiterDemande(String fichierEntree, String fichierPolice, String fichierHistoriq,  String output) throws IOException, OperationInvalideException {
        ...
        appliquerPolice(client, rec, listePolice,historique, fichierHistoriq, output);
    }
    ...
    public static String miseAJourFichierHistorique(HistRemb hist, JSONObject fichHist){
        ...
        return fichHist.toString(3);
    }
    
    public static void ecrireHistoriqueSurDisque(HistRemb hist, String fichierHistoriq) throws IOException{
        
        JSONObject hObj = new JSONObject();
        String obj = miseAJourFichierHistorique(hist, hObj);
        sauvegarderHistorique(fichierHistoriq, obj);
    }
    
    public static void ecrireFichierSortie(Reclamation rec,List<String> listeRemboursement, String output) throws IOException{
        
        String sortie = creationFichierSortie(rec, listeRemboursement);
        try (FileWriter fichierJson = new FileWriter(output)) {
